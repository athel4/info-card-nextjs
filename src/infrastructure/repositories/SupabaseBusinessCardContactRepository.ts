...
export class SupabaseBusinessCardContactRepository implements BusinessCardContactRepository {
  ...
  private mapToEntity(data: any): BusinessCardContact {
    return {
      ...
      secondaryMiddleName: data.secondary_middle_name,
      secondaryLastName: data.secondary_last_name,
      tertiaryFirstName: data.tertiary_first_name,
      tertiaryMiddleName: data.tertiary_middle_name,
      tertiaryLastName: data.tertiary_last_name,
      primaryEmail: data.primary_email,
      secondaryEmail: data.secondary_email,
      tertiaryEmail: data.tertiary_email,
      primaryPhone: data.primary_phone,
      primaryPhoneCountryCode: data.primary_phone_country_code,
      ...
      tertiaryPhoneCountryCode: data.tertiary_phone_country_code,
      company: data.company,
      jobTitle: data.job_title,
      department: data.department,
      primaryWebsite: data.primary_website,
      secondaryWebsite: data.secondary_website,
      tertiaryWebsite: data.tertiary_website,
      ...
      primaryPostalCode: data.primary_postal_code,
      secondaryAddress: data.secondary_address,
      secondaryCity: data.secondary_city,
      secondaryState: data.secondary_state,
      secondaryCountry: data.secondary_country,
      secondaryPostalCode: data.secondary_postal_code,
      tertiaryAddress: data.tertiary_address,
      tertiaryCity: data.tertiary_city,
      tertiaryState: data.tertiary_state,
      tertiaryCountry: data.tertiary_country,
